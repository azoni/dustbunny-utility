...
const values = {
  ...
  COLLECTION_TRAIT: {
    ...
    metroverse: {
      'buildings: induistrial': {
        'wind farm': [0.95, 0.975],
        'solar farm': [0.95, 0.975],
        'rocket launch site': [0.95, 0.975],
      },
  ...
  SMART_WATCH_LIST: ['cyberkongz', 'cool-cats-nft', 'cryptoadz-by-gremplin',
    ...
    'bored-ape-kennel-club', 'bears-deluxe',
    ...
    'supducks', 'the-doge-pound', 'lootproject',
    'karafuru', 'coolpetsnft', 'boredapeyachtclub', 'azuki', 'nft-worlds', 'gutterrats', ' gutterdogs',
    'world-of-women-nft', 'kaiju-kingz', 'mfers', 'bossbeauties',
    'capsulehouse', 'metacard-by-fullsend', 'the-crypto-chicks', 'cyberkongz-vx', 'fluf-world', 'worldwidewebbland', 'alienfrensnft', 'alpacadabraz', 'slotienft', 'coolmans-universe', 'generativedungeon', 'cryptocoven', 'fluf-world-burrows', 'neotokyo-outer-identities', 'slimhoods', 'deadfellaz', 'projectnanopass', 'mypethooligan', 'supducks', 'lil-heroes-by-edgar-plans', 'smilesssvrs', 'pudgypenguins', 'onchainmonkey', 'clonex-mintvial', 'phantabear', 'inbetweeners', 'lazy-lions', 'cryptoadz-by-gremplin', 'creatureworld', 'primeapeplanetpap', 'cryptomories', 'partybear', 'mekaverse', 'theshiboshis', 'robotos-official',
  ],
