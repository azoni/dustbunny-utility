const values = {
	...
	SMART_WATCH_LIST: ['cyberkongz','cool-cats-nft', 'cryptoadz-by-gremplin',
     'cyberkongz', 'doodles-official', 'lootproject',
     'bored-ape-kennel-club', 'desperate-ape-wives', 'bears-deluxe',
     'clonex', 'collectvox', 'creatureworld', 'theshiboshis',
     'meebits', 'guttercatgang', 'gutterrats', 'gutterdogs', 'veefriends', 'rumble-kong-league',
     'deadfellaz', 'lazy-lions', 'pudgypenguins', 'forgottenruneswizardscult',
     'supducks', 'the-doge-pound', 'lootproject',
     'karafuru', 'coolpetsnft', 'azuki', 'nft-worlds'],
